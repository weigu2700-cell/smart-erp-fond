...
.welcome-panel { min-height: 148px; padding: 28px 34px; display: flex; align-items: center; justify-content: space-between; overflow: hidden; border: 1px solid #d2e3fc; border-left: 4px solid #1a73e8; border-radius: 10px; color: #202124; background: #fff; box-shadow: var(--shadow-panel); }
...
.metric-card, .dashboard-card { border: 1px solid var(--border-color); border-radius: 9px; box-shadow: var(--shadow-panel); }
...
.metric-content { min-width: 0; display: flex; flex-direction: column; gap: 4px; } .metric-label { color: var(--text-secondary); font-size: 12px; } .metric-content strong { color: #111827; font-size: 20px; letter-spacing: -.3px; } .metric-trend { color: #059669; font-size: 11px; } .metric-trend svg { width: 12px; vertical-align: -2px; } .metric-trend em { margin-left: 4px; color: #94a3b8; font-style: normal; }
...
.card-heading { display: flex; align-items: center; justify-content: space-between; } .card-heading > div { display: flex; flex-direction: column; gap: 4px; } .card-heading strong { color: #1e293b; font-size: 15px; } .card-heading span { color: #94a3b8; font-size: 12px; font-weight: 400; }
.quick-links { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; padding-top: 18px; } .quick-link { min-height: 104px; position: relative; padding: 16px 13px; display: flex; flex-direction: column; gap: 10px; border: 1px solid #edf1f6; border-radius: 7px; color: inherit; text-decoration: none; transition: all .2s ease; } .quick-link:hover { border-color: #aecbfa; background: #f8fbff; transform: translateY(-2px); } .quick-link-icon { width: 30px; height: 30px; display: grid; place-items: center; border-radius: 7px; color: #1a73e8; background: #e8f0fe; } .quick-link > span:nth-child(2) { display: flex; flex-direction: column; gap: 3px; } .quick-link strong { color: #3c4043; font-size: 13px; } .quick-link small { color: #80868b; font-size: 11px; } .quick-link-arrow { position: absolute; right: 10px; top: 10px; color: #9aa0a6; font-size: 13px; transform: rotate(45deg); }
.activity-list { padding-top: 8px; } .activity-item { min-height: 62px; display: flex; align-items: center; gap: 13px; border-bottom: 1px solid #f1f5f9; } .activity-item:last-child { border-bottom: 0; } .activity-dot { width: 8px; height: 8px; flex: 0 0 8px; border-radius: 50%; } .activity-dot--success { background: #10b981; box-shadow: 0 0 0 4px #d1fae5; } .activity-dot--primary { background: #3b82f6; box-shadow: 0 0 0 4px #dbeafe; } .activity-dot--warning { background: #f59e0b; box-shadow: 0 0 0 4px #fef3c7; } .activity-item div { display: flex; flex-direction: column; gap: 4px; } .activity-item strong { color: #475569; font-size: 13px; font-weight: 500; } .activity-item span { color: #94a3b8; font-size: 11px; }
