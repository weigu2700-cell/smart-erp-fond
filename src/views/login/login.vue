...
.login-content { position: relative; min-height: 100vh; display: grid; grid-template-columns: minmax(420px, 1.1fr) minmax(420px, .9fr); overflow: hidden; background: #fff; }
...
.login-intro { position: relative; z-index: 1; overflow: hidden; padding: 48px 10%; display: flex; flex-direction: column; justify-content: space-between; color: #202124; background: transparent; }
