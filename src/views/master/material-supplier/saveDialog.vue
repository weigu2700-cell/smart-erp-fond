  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
      ...
      <el-form-item label="采购价" prop="purchasePrice">
        <el-input-number v-model="form.purchasePrice" :min="0" :precision="2" placeholder="请输入采购价" style="width: 100%" />
      </el-form-item>
      <el-form-item label="交期(天)" prop="leadTimeDays">
        <el-input-number v-model="form.leadTimeDays" :min="0" :precision="0" placeholder="请输入采购交期" style="width: 100%" />
      </el-form-item>
      <el-form-item label="最小起订量" prop="minOrderQty">
        <el-input-number v-model="form.minOrderQty" :min="0" :precision="0" placeholder="请输入最小起订量" style="width: 100%" />
      </el-form-item>
