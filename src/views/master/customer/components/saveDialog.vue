...
import type { CustomerCreateRequest, CustomerUpdateRequest, CustomerVO } from "@/types/master/customer.ts";
...
const emit = defineEmits<{
  (e: 'cancel'): void
  (e: 'submit', form: CustomerCreateRequest | CustomerUpdateRequest): void
}>()
